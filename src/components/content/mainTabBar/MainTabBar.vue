<template>
	<div>
		<tab-bar>
			<tab-bar-item path="/home" activeColor="#FF5378" >
			...
			<tab-bar-item path="/category" activeColor="#FF5378">
			...
			<tab-bar-item path="cart" activeColor="#FF5378">
			...
			<tab-bar-item path="profile" activeColor="#FF5378">
...
import TabBarItem from 'components/common/tabbar/TarBarItem.vue'
